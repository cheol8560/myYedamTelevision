            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
						...
						<li><a href="${pageContext.request.contextPath}/getOnBroadcastList.do" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>메인페이지 이동</p></a></li>
