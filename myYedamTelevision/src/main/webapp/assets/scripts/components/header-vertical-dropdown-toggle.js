...
var HeaderVerticalDropdown = function() {
    ...
    var handleHeaderVerticalDropdownToggle = function() {
        $('.header-vertical-menu .nav-item').children('a').on('click', function(event) {
            ...
            $(this).toggleClass('nav-item-open').next('.nav-dropdown-menu').slideToggle(400).end();
        });
    }
...
$(document).ready(function() {
    ...
    $('.header-vertical-menu .nav-item').children('a').toggleClass('nav-item-open').next('.nav-dropdown-menu').slideToggle(400);
});
