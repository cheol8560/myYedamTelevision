		...
		$(".get-icon")
				.on(
						...
						function() {
							...
							if ('${param.mode}' == 1) {
								opener.document
										.getElementsByName("contentIcon")[0].value = thisTxt;
							} else {
								opener.document
										.getElementsByName("contentIcon")[1].value = thisTxt;
							}
...
<div class="row fontawesome-icon-list">
	...
	<div class="row fontawesome-icon-list">
		...
		<div class="fa-item col-md-offset-1 col-md-2 col-sm-4 get-icon" style="font-size: 16px;">
			<i class="fa fa-soccer-ball-o"></i> fa-soccer-ball-o <span
	...
	<div class="row fontawesome-icon-list">
		...
		<div class="fa-item col-md-offset-1 col-md-2 col-sm-4 get-icon" style="font-size: 16px;">
			<i class="fa fa-bar-chart-o"></i> fa-bar-chart-o <span
				class="text-muted">(alias)</span>
		</div>
		<div class="fa-item col-md-offset-1 col-md-2 col-sm-4 get-icon" style="font-size: 16px;">
